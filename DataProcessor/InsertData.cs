        ...
        public static void Main(string[] args)
        {
            ...
            using (sqlCon)
            {
                ...
                foreach (string klant in klanten)
                {
                    ...
                    cmd.Parameters.AddWithValue("@K_Intresse", HeeftInteresses(klantSplit[5]));
                    cmd.Parameters.AddWithValue("@K_Subscription", HeeftMembers(klantSplit[6]));
            ...
            string HeeftMembers(string member)
            {
                if (member == "")
                {
                    return "";
            ...
            object HeeftInteresses(string interesse)
            {
                if (interesse == "")
                {
                    return "";
                }
                else return interesse;
            }
        }
    }
